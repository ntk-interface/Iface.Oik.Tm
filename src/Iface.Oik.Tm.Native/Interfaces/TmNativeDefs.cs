...
namespace Iface.Oik.Tm.Native.Interfaces
{
	...
	public class TmNativeDefs
	{
		...
		public const string TmCalcConfFile = "calc.cfg";
		...
		[StructLayout(LayoutKind.Sequential)]
		public struct CfsAccessDescriptor
		{
			//DWORD ResourceType;
		...
		[StructLayout(LayoutKind.Sequential)]
		public struct CfsExtSrvrtDescriptor
		{
			//	typedef struct {
			//BYTE DoUserID;
			public byte DoUserID;
			//	DWORD MaxUserID;
			public UInt32 MaxUserID;
			//	BYTE DoGroup;
			public byte DoGroup;
			//	BYTE DoKeyID;
			public byte DoKeyID;
