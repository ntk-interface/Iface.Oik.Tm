...
namespace Iface.Oik.Tm.Utils
{
  public static class DictionaryExtensions
  {
    ...
    public static TValue ValueOrFirst<TKey, TValue>(this IDictionary<TKey, TValue> dictionary,
                                                    TKey                           key)
    {
      if (dictionary == null)
      {
      ...
      return dictionary.TryGetValue(key, out var value) ? value : dictionary.Values.FirstOrDefault();
    }
  }
}