...
namespace Iface.Oik.Tm.Interfaces
{
  ...
  public enum TobBindingType
  {
    ...
    [Description("Видео - окно К.А.")]                              VideoForTmTagWindow        = 30,
    ...
    [Description("Телепараметр - окно К.А.")]                       TmForTmTagWindow           = 34,
    [Description("ТЕХ данные - окно К.А.")]                         TechParamForTmTagWindow    = 35,
    [Description("Документ - окно К.А.")]                           DocumentForTmTagWindow     = 36,
    [Description("Запуск программы - окно К.А.")]                   ProcessForTmTagWindow      = 37,
    [Description("Вызов функции дорасчета - окно К.А.")]            CalcScriptForTmTagWindow   = 38,
    [Description("Метка на карте - окно К.А.")]                     MapPlacemarkForTmTagWindow = 39,
    [Description("Телепараметр - кнопка в окне К.А.")]              TmForTmTagWindowButton     = 40,
    [Description("Вызов функции дорасчета (ТУ) - окно К.А.")]       CalcScriptTelecontrolForTmTagWindow = 41,
  }
