...
namespace Iface.Oik.Tm.Interfaces
{
  ...
  public enum TobBindingType
  {
    ...
    [Description("Видео - окно телепараметра")]                     VideoForTmTagWindow        = 30,
    ...
    [Description("Телепараметр - окно телепараметра")]              TmForTmTagWindow           = 34,
    [Description("ТЕХ данные - окно телепараметра")]                TechParamForTmTagWindow    = 35,
    [Description("Документ - окно телепараметра")]                  DocumentForTmTagWindow     = 36,
    [Description("Запуск программы - окно телепараметра")]          ProcessForTmTagWindow      = 37,
    [Description("Вызов функции дорасчета - окно телепараметра")]   CalcScriptForTmTagWindow   = 38,
    [Description("Метка на карте - окно телепараметра")]            MapPlacemarkForTmTagWindow = 39,
    [Description("Телепараметр - кнопка в окне телепараметра")]     TmForTmTagWindowButton     = 40,
  }
