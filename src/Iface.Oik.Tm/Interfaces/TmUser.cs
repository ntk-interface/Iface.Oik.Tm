...
{
  public class TmUser : TmNotifyPropertyChanged, ITmServerTraceable
  {
    ...
    {
      var name    = EncodingUtil.BytesToString(ifaceUser.Name);
      var comment = EncodingUtil.BytesToString(ifaceUser.Comment);
