...
public class DeltaComponent : DeltaComponentNotifiable
{
  ...
  {
    return HashCode.Combine(Name, Type, TraceChain);
  }
...
public class DeltaComponentErrorState : IEquatable<DeltaComponentErrorState>
{
  public DeltaComponent       Component { get; }
  public DeltaComponentStates State     => Component.State;
  
  
  public DeltaComponentErrorState(DeltaComponent component)
  {
    Component = component;
  }

  public bool Equals(DeltaComponentErrorState other)
  {
    return other is not null &&
           Component.TraceChain == other.Component.TraceChain  &&
           State == other.State;
  }

  public override bool Equals(object obj)
  {
    return Equals(obj as DeltaComponentErrorState);
  }
  
  public override int GetHashCode()
  {
    return HashCode.Combine(Component.TraceChain, Component.State);
  }
}